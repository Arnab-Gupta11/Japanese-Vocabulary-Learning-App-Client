const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-10 bg-black to-130% text-white">
        <aside>
          <div>
        ...
        <nav>
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-[#9946F0]">
